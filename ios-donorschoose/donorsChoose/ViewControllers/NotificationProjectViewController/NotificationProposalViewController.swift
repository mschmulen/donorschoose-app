...
open class NotificationProposalViewController: UIViewController {
    ...
    let proposalModel:ProposalDataModel
    ...
    public init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?, title:String, message:String , proposal:ProposalDataModel) {
    ...
    public convenience init( title:String, message:String, proposal:ProposalDataModel)
    {
